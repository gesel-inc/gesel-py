...
Welcome to `gesel` contributor's guide.
...
If you experience bugs or general issues with `gesel`, please have a look
...
You can help improve `gesel` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`gesel` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `gesel`'s files. While this mechanism can
...
```
conda create -n gesel python=3 six virtualenv pytest pytest-cov
conda activate gesel
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/gesel.git
   cd gesel
   ```
...
5. Install [pre-commit]:
   ...
   `gesel` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/gesel-inc/gesel-py
[issue tracker]: https://github.com/gesel-inc/gesel-py/issues
